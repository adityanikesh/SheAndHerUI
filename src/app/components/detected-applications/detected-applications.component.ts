...
@Component({
  selector: 'app-detected-applications',
  templateUrl: './detected-applications.component.html',
  styleUrls: ['./detected-applications.component.scss']
})
export class DetectedApplicationsComponent implements OnInit {

  listApplication: Application[] = null;
  dataSource = null;
  displayedColumnsDetectedApps: string[] = ['select', 'appName', 'custName', 'deptName', 'action'];
